...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image'] ?? "./assets/products/product-1.jpg" ?>" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">HADI MaRt </a>(4.5 out of 5 | 18,198 ratings)</small>
                ...
                <div class="size my-3">
                    ...
                    <div class="d-flex justify-content-between w-75">
                        ...
                        <div class="font-rubik border p-2">
                            <button class="btn p-0 font-size-14">EX-Large</button>
                        </div>
                    </div>
                </div>
                <!-- !size -->
