            ...
            <div class="row m-0" >
                <di0v class="col-lg-4 offset-lg-2" id="box">
                    <div class="text-center pb-5" id="text">
                        ...
                        <p class="p-1 m-0 font-ubuntu text-black-50">Login first to proceeed checkout</p>
                        <span class="font-ubuntu text-black-50">Create a new <a href="register.php">account</a></span>
                    </div>

                    <div class="d-flex justify-content-center">
                        <form action="payment.php" method="post" enctype="multipart/form-data" id="log-form">
